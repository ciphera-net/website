...
| | <ToolLogo src="/blog/tools/recaptcha.png" /> reCAPTCHA | <ToolLogo src="/blog/tools/hcaptcha.png?v=2" /> hCaptcha | <ToolLogo src="/blog/tools/turnstile.png" /> Turnstile | <ToolLogo src="/blog/tools/ciphera-captcha.png" /> Ciphera Captcha |
|---|---|---|---|---|
...
- **Swiss infrastructure, Belgian company.** It runs on the same [Swiss-hosted](/blog/why-swiss-infrastructure-matters-for-data-privacy) infrastructure as the rest of Ciphera, operated by Ciphera BV under GDPR and the Swiss [FADP](/glossary/fadp) — no US company in the path.
