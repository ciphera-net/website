          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none space-y-10">
              ...
              <section>
                ...
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6 mt-3">
                  <p className="text-neutral-600 dark:text-neutral-400">
                    <strong className="text-neutral-900 dark:text-white">Ciphera B.V.</strong><br />
              ...
              <section>
                ...
                <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mt-2">
              ...
              <section>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-neutral-600 dark:text-neutral-400 mt-2">
                    <thead>
                      <tr className="border-b border-neutral-200 dark:border-neutral-700">
                        <th className="text-left py-2 pr-4 font-semibold text-neutral-900 dark:text-white">Name</th>
                        ...
                        <th className="text-left py-2 font-semibold text-neutral-900 dark:text-white">Duration</th>
                      </tr>
                    </thead>
                    <tbody>
              ...
              <section>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-neutral-600 dark:text-neutral-400 mt-2">
                    <thead>
                      <tr className="border-b border-neutral-200 dark:border-neutral-700">
                        <th className="text-left py-2 pr-4 font-semibold text-neutral-900 dark:text-white">Data Type</th>
                        <th className="text-left py-2 pr-4 font-semibold text-neutral-900 dark:text-white">Retention Period</th>
                        <th className="text-left py-2 font-semibold text-neutral-900 dark:text-white">Basis</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-neutral-100 dark:border-neutral-800">
              ...
              <section>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-neutral-600 dark:text-neutral-400 mt-2">
                    <thead>
                      <tr className="border-b border-neutral-200 dark:border-neutral-700">
                        <th className="text-left py-2 pr-4 font-semibold text-neutral-900 dark:text-white">Service</th>
                        <th className="text-left py-2 pr-4 font-semibold text-neutral-900 dark:text-white">Purpose</th>
                        <th className="text-left py-2 pr-4 font-semibold text-neutral-900 dark:text-white">Data Processed</th>
                        <th className="text-left py-2 font-semibold text-neutral-900 dark:text-white">Location</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-neutral-100 dark:border-neutral-800">
