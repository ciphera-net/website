            ...
            <div className="prose prose-invert max-w-none space-y-10">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li><strong>Password limitations:</strong> Because we use the OPAQUE protocol, your password never reaches our servers, and we store no password, password hash, or verifier. We therefore cannot reset or recover your password. Account recovery uses the 24-word recovery phrase shown when your account is created, which enrols a second credential we cannot read; accounts created before 7 September 2026 set it up from Security settings, using the current password. If you lose your password and have no recovery phrase enrolled, your account cannot be recovered. Email-based password reset is not available by design.</li>
                </ul>
              </section>
