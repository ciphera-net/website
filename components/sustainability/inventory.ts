 ...
 * Exoscale compute API on 2026-07-26 (evening): 12 production instances, all
 * in CH-DK-2 (Zurich).
 *
 ...
 * internal-ops and registry-ops were retired the same day. Because this page
...
export const STATIC_INVENTORY: InventoryItem[] = [
  ...
  },
  {
    ...
    ramGb: 2,
    zone: 'CH-DK-2',
    purpose: 'Shared ingress for the remaining orchestrated jobs',
  },
  {
