            ...
            return (
              ...
              >
                <div className="h-full card card-hover p-6 lg:p-8">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 bg-gradient-to-br from-brand-orange/10 to-brand-orange/5">
